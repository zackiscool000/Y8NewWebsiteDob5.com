var LATEST_VERSION = "v3.1.72"; /* put in a separate bm-version that can be updated by php */
...
var hostUrl = '.';
var elem = document.getElementById('sdk-javascript');
var styling = document.getElementById('sdk-stylesheet');
elem.parentElement.removeChild(elem);
styling.parentElement.removeChild(styling);
load_script(hostUrl);
}


var load_script = function (hostURL) {
...
script.setAttribute('id', 'sdk-javascript');
script.async = true;
...
ss.setAttribute('id', 'sdk-stylesheet');
